...
> **Level:** 3
> **Path:** `domains/knowledge/science/science.md`
> **Parent:** `domains/knowledge/knowledge.md`

## Purpose
Rules for science, technology, space, and related knowledge queries.
...
3. If a sub-domain is needed, create `domains/knowledge/science/<subdomain>/<subdomain>.md` and add it to the registry in `AGENTS.md`.
