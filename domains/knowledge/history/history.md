...
> **Level:** 3
> **Path:** `domains/knowledge/history/history.md`
> **Parent:** `domains/knowledge/knowledge.md`

## Purpose
Rules for history domain — includes academic content, teaching materials (ЕГЭ/ОГЭ prep), and general history queries.
...
3. If a sub-domain is needed, create `domains/knowledge/history/<subdomain>/<subdomain>.md` and add it to the registry in `AGENTS.md`.
